...
const EVOLUTIONS = {
  ...
  'Zudomon':         { xpToEvolve: 800, evolvesTo: ['Vikemon', 'Plesiomon', 'Metalseadramon', 'Gigaseadramon'] },
  'Magnaangemon':    { xpToEvolve: 800, evolvesTo: ['Seraphimon', 'Valkyrimon'] },
  ...
  'Ladydevimon':     { xpToEvolve: 800, evolvesTo: ['Piedmon', 'Rosemon'] },
  'Machgaogamon':    { xpToEvolve: 800, evolvesTo: ['Miragegaogamon', 'Megagargomon', 'Metalgarurumon'] },
  'Mamemon':         { xpToEvolve: 800, evolvesTo: ['Princemamemon', 'Pukumon', 'Puppetmon'] },
  ...
  'Megaseadramon':   { xpToEvolve: 800, evolvesTo: ['Metalseadramon', 'Gigaseadramon', 'Machinedramon', 'Plesiomon'] },
  'Metaltyrannomon': { xpToEvolve: 800, evolvesTo: ['Machinedramon', 'Wargreymon', 'Blackwargreymon'] },
  'Monzaemon':       { xpToEvolve: 800, evolvesTo: ['Saberleomon', 'Seraphimon'] },
  'Okuwamon':        { xpToEvolve: 800, evolvesTo: ['Grankuwagamon', 'Herculeskabuterimon'] },
  'Pandamon':        { xpToEvolve: 800, evolvesTo: ['Bancholeomon', 'Metalgarurumon'] },
  'Parrotmon':       { xpToEvolve: 800, evolvesTo: ['Metalgarurumon', 'Phoenixmon'] },
  'Phantomon':       { xpToEvolve: 800, evolvesTo: ['Piedmon'] },
  'Piximon':         { xpToEvolve: 800, evolvesTo: ['Ophanimon'] },
  'Rapidmon':        { xpToEvolve: 800, evolvesTo: ['Megagargomon', 'Vikemon'] },
  'Rizegreymon':     { xpToEvolve: 800, evolvesTo: ['Slayerdramon', 'Victorygreymon'] },
  'Scorpiomon':      { xpToEvolve: 800, evolvesTo: ['Pukumon'] },
  'Shogungekomon':   { xpToEvolve: 800, evolvesTo: ['Plesiomon', 'Pukumon'] },
  'Skullgreymon':    { xpToEvolve: 800, evolvesTo: ['Blackwargreymon', 'Skullmammothmon'] },
  'Skullmeramon':    { xpToEvolve: 800, evolvesTo: [] },
  'Superstarmon':    { xpToEvolve: 800, evolvesTo: ['Princemamemon'] },
  'Triceramon':      { xpToEvolve: 800, evolvesTo: ['Brakedramon', 'Saberleomon'] },
  'Vademon':         { xpToEvolve: 800, evolvesTo: ['Hiandromon', 'Herculeskabuterimon'] },
  'Warumonzaemon':   { xpToEvolve: 800, evolvesTo: ['Metaletemon', 'Grankuwagamon'] },
  'Whamon':          { xpToEvolve: 800, evolvesTo: ['Plesiomon', 'Metalseadramon'] },
  'Wingdramon':      { xpToEvolve: 800, evolvesTo: ['Slayerdramon'] },
  'Taomon':          { xpToEvolve: 800, evolvesTo: ['Dianamon', 'Saberleomon'] },
  'Myotismon':       { xpToEvolve: 800, evolvesTo: ['Piedmon'] },
  'Antylamon':       { xpToEvolve: 800, evolvesTo: ['Dianamon', 'Ophanimon'] },
  'Wargrowlmon':     { xpToEvolve: 800, evolvesTo: ['Gallantmon'] },
