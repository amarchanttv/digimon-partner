...
const EVOLUTIONS = {
  ...
  'Metalgreymon':    { xpToEvolve: 800, evolvesTo: [] },
  'Weregarurumon':   { xpToEvolve: 800, evolvesTo: [] },
  'Garudamon':       { xpToEvolve: 800, evolvesTo: [] },
  'Megakabuterimon': { xpToEvolve: 800, evolvesTo: [] },
  'Lillymon':        { xpToEvolve: 800, evolvesTo: [] },
  'Zudomon':         { xpToEvolve: 800, evolvesTo: [] },
  'Magnaangemon':    { xpToEvolve: 800, evolvesTo: [] },
  'Angewomon':       { xpToEvolve: 800, evolvesTo: [] },
  'Andromon':        { xpToEvolve: 800, evolvesTo: [] },
  'Bigmamemon':      { xpToEvolve: 800, evolvesTo: [] },
  'Cherrymon':       { xpToEvolve: 800, evolvesTo: [] },
  'Crescemon':       { xpToEvolve: 800, evolvesTo: [] },
  'Crowmon':         { xpToEvolve: 800, evolvesTo: [] },
  'Cyberdramon':     { xpToEvolve: 800, evolvesTo: [] },
  'Deramon':         { xpToEvolve: 800, evolvesTo: [] },
  'Divermon':        { xpToEvolve: 800, evolvesTo: [] },
  'Dragomon':        { xpToEvolve: 800, evolvesTo: [] },
  'Etemon':          { xpToEvolve: 800, evolvesTo: [] },
  'Flaremon':        { xpToEvolve: 800, evolvesTo: [] },
  'Garbagemon':      { xpToEvolve: 800, evolvesTo: [] },
  'Groundramon':     { xpToEvolve: 800, evolvesTo: [] },
  'Knightmon':       { xpToEvolve: 800, evolvesTo: [] },
  'Ladydevimon':     { xpToEvolve: 800, evolvesTo: [] },
  'Machgaogamon':    { xpToEvolve: 800, evolvesTo: [] },
  'Mamemon':         { xpToEvolve: 800, evolvesTo: [] },
  'Mammothmon':      { xpToEvolve: 800, evolvesTo: [] },
  'Megadramon':      { xpToEvolve: 800, evolvesTo: [] },
  'Megaseadramon':   { xpToEvolve: 800, evolvesTo: [] },
  'Metaltyrannomon': { xpToEvolve: 800, evolvesTo: [] },
  'Monzaemon':       { xpToEvolve: 800, evolvesTo: [] },
  'Okuwamon':        { xpToEvolve: 800, evolvesTo: [] },
  'Pandamon':        { xpToEvolve: 800, evolvesTo: [] },
  'Parrotmon':       { xpToEvolve: 800, evolvesTo: [] },
  'Phantomon':       { xpToEvolve: 800, evolvesTo: [] },
  'Piximon':         { xpToEvolve: 800, evolvesTo: [] },
  'Rapidmon':        { xpToEvolve: 800, evolvesTo: [] },
  'Rizegreymon':     { xpToEvolve: 800, evolvesTo: [] },
  'Scorpiomon':      { xpToEvolve: 800, evolvesTo: [] },
  'Shogungekomon':   { xpToEvolve: 800, evolvesTo: [] },
  'Skullgreymon':    { xpToEvolve: 800, evolvesTo: [] },
  'Skullmeramon':    { xpToEvolve: 800, evolvesTo: [] },
  'Superstarmon':    { xpToEvolve: 800, evolvesTo: [] },
  'Triceramon':      { xpToEvolve: 800, evolvesTo: [] },
  'Vademon':         { xpToEvolve: 800, evolvesTo: [] },
  'Warumonzaemon':   { xpToEvolve: 800, evolvesTo: [] },
  'Whamon':          { xpToEvolve: 800, evolvesTo: [] },
  'Wingdramon':      { xpToEvolve: 800, evolvesTo: [] },
  'Taomon':          { xpToEvolve: 800, evolvesTo: [] },
  'Myotismon':       { xpToEvolve: 800, evolvesTo: [] },
  'Antylamon':       { xpToEvolve: 800, evolvesTo: [] },
  'Wargrowlmon':     { xpToEvolve: 800, evolvesTo: [] },
  ...
  'Shinegraymon':        { xpToEvolve: null, evolvesTo: [] },
