...
const EVOLUTIONS = {
  ...
  'Gomamon':    { xpToEvolve: 150, evolvesTo: ['Ikkakumon', 'Ankylomon', 'Frigimon','Seadramon', 'Shellmon', 'Sorcerimon', 'Mojyamon']    },
  'Patamon':    { xpToEvolve: 150, evolvesTo: ['Angemon', 'Kyubimon', 'Unimon', 'Wizardmon', 'Centarumon']      },
  'Salamon':    { xpToEvolve: 150, evolvesTo: ['Gatomon', 'Veedramon', 'Gargomon', 'Centarumon', 'Sorcerimon']     },
  ...
  'Demidevimon':{ xpToEvolve: 150, evolvesTo: ['Devimon', 'Icedevimon', 'Bakemon', 'Kyubimon', 'Ogremon' ] },
  'Elecmon':    { xpToEvolve: 150, evolvesTo: ['Leomon', 'Angemon', 'Gekomon', 'Garurumon', 'Unimon', 'Kokatorimon'] },
  ...
  'Hagurumon':  { xpToEvolve: 150, evolvesTo: ['Guardromon', 'Clockmon', 'Starmon', ] },
  'Kunemon':    { xpToEvolve: 150, evolvesTo: ['Kabuterimon', 'Kuwagamon', 'Bakemon', 'Vegiemon'] },
  'Veemon':     { xpToEvolve: 150, evolvesTo: ['Veedramon', 'Meramon'] },
  'Toyagumon':  { xpToEvolve: 150, evolvesTo: ['Guardromon', 'Starmon', 'Sukamon', 'Clockmon'] },
  ...
  'Armadimon':  { xpToEvolve: 150, evolvesTo: ['Ankylomon', 'Monochromon'] },
  ...
  'Coronamon':  { xpToEvolve: 150, evolvesTo: ['Firamon', 'Meramon', 'Birdramon', 'Growlmon', 'Geogreymon'] },
  'Gazimon':    { xpToEvolve: 150, evolvesTo: ['Numemon', 'Gaogamon', 'Leomon'] },
  'Gizamon':    { xpToEvolve: 150, evolvesTo: ['Ankylomon', 'Geremon'] },
