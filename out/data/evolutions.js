...
const EVOLUTIONS = {
  ...
  'Gomamon':    { xpToEvolve: 150, evolvesTo: ['Ikkakumon', 'Seadramon', 'Shellmon', 'Sorcerimon', 'Mojyamon']    },
  'Patamon':    { xpToEvolve: 150, evolvesTo: ['Angemon', 'Unimon', 'Gatomon', 'Birdramon', 'Leomon']      },
  'Salamon':    { xpToEvolve: 150, evolvesTo: ['Gatomon', 'Angemon', 'Leomon', 'Veedramon', 'Gargomon', 'Centarumon']     },
  'Guilmon':    { xpToEvolve: 150, evolvesTo: [] },
  'Dracomon':   { xpToEvolve: 150, evolvesTo: [] },
  'Demidevimon':{ xpToEvolve: 150, evolvesTo: [] },
  'Elecmon':    { xpToEvolve: 150, evolvesTo: [] },
  'Gaomon':     { xpToEvolve: 150, evolvesTo: [] },
  'Goblimon':   { xpToEvolve: 150, evolvesTo: [] },
  'Hagurumon':  { xpToEvolve: 150, evolvesTo: [] },
  'Kunemon':    { xpToEvolve: 150, evolvesTo: [] },
  'Veemon':     { xpToEvolve: 150, evolvesTo: [] },
  'Toyagumon':  { xpToEvolve: 150, evolvesTo: [] },
  'Falcomon':   { xpToEvolve: 150, evolvesTo: [] },
  'Floramon':   { xpToEvolve: 150, evolvesTo: [] },
  'Mushroomon': { xpToEvolve: 150, evolvesTo: [] },
  'Armadimon':  { xpToEvolve: 150, evolvesTo: [] },
  'Bakumon':    { xpToEvolve: 150, evolvesTo: [] },
  'Candlemon':  { xpToEvolve: 150, evolvesTo: [] },
  'Coronamon':  { xpToEvolve: 150, evolvesTo: [] },
  'Gazimon':    { xpToEvolve: 150, evolvesTo: [] },
  'Gizamon':    { xpToEvolve: 150, evolvesTo: [] },
  'Gottsumon':  { xpToEvolve: 150, evolvesTo: [] },
  'Kamemon':    { xpToEvolve: 150, evolvesTo: [] },
  'Lunamon':    { xpToEvolve: 150, evolvesTo: [] },
  'Otamamon':   { xpToEvolve: 150, evolvesTo: [] },
  'Renamon':    { xpToEvolve: 150, evolvesTo: [] },
