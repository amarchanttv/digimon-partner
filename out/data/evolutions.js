...
const EVOLUTIONS = {
  ...
  'Greymon':     { xpToEvolve: 400, evolvesTo: ['Metalgreymon', 'Skullgreymon', 'Megadramon', 'Metaltyrannomon']       },
  ...
  'Clockmon': { xpToEvolve: 400, evolvesTo: ['Andromon', 'Knightmon', 'Zudomon'] },
  ...
  'Devimon': { xpToEvolve: 400, evolvesTo: ['Myotismon', 'Ladydevimon', 'Phantomon'] },
  ...
  'Gargomon': { xpToEvolve: 400, evolvesTo: ['Rapidmon', 'Antylamon'] },
  ...
  'Growlmon':      { xpToEvolve: 400, evolvesTo: ['Groundramon', 'Metalgreymon', 'Metaltyrannomon', 'Skullgreymon'] },
  ...
  'Shellmon':      { xpToEvolve: 400, evolvesTo: ['Megaseadramon', 'Piximon', 'Scorpiomon', 'Whamon'] },
  ...
  'Tyranomon':     { xpToEvolve: 400, evolvesTo: ['Metalgreymon', 'Metaltyrannomon', 'Skullgreymon'] },´
